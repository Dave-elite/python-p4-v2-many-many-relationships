...
class Employee(db.Model):
    ...
    #Asscociation proxy to get projects for this employee through assignments
...
class Meeting(db.Model):
    ...
    # Relationship mapping the meetings to related employees
...
class Project(db.Model):
    ...
    #Asscociation proxy to get employees for this project through assignment
...
class Assignment(db.Model):
    ...
    # foreign key to store the emplotyee id
    employee_id = db.Column(db.Integer, db.ForeignKey('employees.id'))
    #foreign key to store the project id
    project_id = db.Column(db.Integer, db.ForeignKey('projects.id'))
    
    
    #Relationships mapping the assignment to related employees
    
    employee = db.relationship('Employee', back_populates='assignments')
    
    #Relationships mapping the assignment to related projects
